		...
		<div id="site">
		  ...
		  <div id="topo">
			...
			<div id="container">
			  <div id="submenu">
			        <div id="div">
			          <p style="margin-top:15px; font-weight:normal; padding-right:5px; text-align:center">Preencha o formul&aacute;rio ao lado ou utilize uma das formas abaixo para entrar em contato.</p>
			          <p style="margin-top:15px; font-weight:normal; padding-right:5px; text-align:center">Endere&ccedil;o: Rua D. Pedro I, n&ordm; 9<br>
			        ...
			        <p style="margin-top:15px; font-weight:normal; padding-right:5px; text-align:center">&nbsp;</p>
	          </div>
				<div id="conteudo">
					  <h1>Contatos</h1>
					  <form name="form1" method="post" id="form1" action="enviaEmail.php" onSubmit="return validaContato(this)">
					    <table width="100%" border="0" cellspacing="0" cellpadding="4">
						 <tr>
                            <td colspan="3" align="center" class="ok">Mensagem enviada com sucesso! </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="right" valign="top" class="label"><span class="campoRequerido">*</span>mensagem</td>
