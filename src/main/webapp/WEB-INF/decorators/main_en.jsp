		...
		<tr>
			<td align="center" valign="top">
						...
						<div id="idioma"> 
							<p>
								<a href="/mudaIdioma.groovy?idioma=pt-br&amp;pag=<decorator:getProperty property="meta.pagina"/>">
									<img src="/imagens/brasil2.gif" alt="Brasil" width="18" height="12" border="0" align="top"/> portugu&ecirc;s
								</a>
							</p>
							<p>
								<a href="../mudaIdioma.groovy?idioma=en&amp;pag=<decorator:getProperty property="meta.pagina" default="empresa.html"/>">
									<img src="/imagens/eua.gif" alt="EUA" width="18" height="12" border="0" align="top"/> english
								</a>
							</p>							
						</div>
					</div>
						...
						<tr>
							<td width="221" align="left" style="background:url(/imagens/base_menu.jpg) no-repeat top right">
								<ul id="primary-nav">
								  ...
								  <li class="menuparent"><a href="#">Products</a> 
									<ul>
								  ...
								  <li><a href="oportunidades.html">Opportunities</a> </li>
								  <li><a href="investidores.html">Investor Relationship</a> </li>
								  <li><a href="contatos.html">Contacts</a> </li>
								</ul>
							</td>
							<td width="554" align="left"><img src="/imagens/<decorator:getProperty property="meta.img_topo" default="topo_averone_en.jpg"/>" alt="Averone" width="548" height="205" /></td>						</tr>
						</table>
					</div>
					<div id="container">
	      	...
	      	<decorator:body />
					...
					<div id="rodape">
						All rights reserved &reg; Averone.com.br
					</div>
				</div>
			</td>
		</tr>
